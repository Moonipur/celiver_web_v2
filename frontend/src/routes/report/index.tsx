    ...
    <div className="max-w-7xl p-6 mx-auto space-y-6">
      <header className="space-y-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">
            Report Your Prediction
          </h1>
          <p className="text-muted-foreground">
            Enter your order <span className="italic">Case ID</span> to report
            PDF.
          </p>
        </div>
      ...
      {q ? (
        ...
        <div className="flex flex-col items-center justify-center p-20 text-center">
          ...
          <h2 className="text-xl font-semibold">Ready to Report</h2>
          <p className="text-muted-foreground max-w-sm">
            Enter a Case ID above and click search to retrieve sample cfDNA data
            and CEliver score.
          </p>
        </div>
      )}
